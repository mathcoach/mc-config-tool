 ...
 * </p>
 * <ul>
 * <li>Create and initialize a OriginStringSubstitutor with the map that contains the values for the variables you want to
 make available.</li>
 ...
 * String templateString = &quot;The ${animal} jumped over the ${target}.&quot;;
 ...
 // Build OriginStringSubstitutor
 OriginStringSubstitutor sub = new OriginStringSubstitutor(valuesMap);
 ...
 *
 * <p>
 * {@code OriginStringSubstitutor} supports throwing exceptions for unresolved variables, you enable this by setting calling
 ...
 *
 * <pre>
 final OriginStringSubstitutor interpolator = OriginStringSubstitutor.createInterpolator();
 ...
 *
 * <p>
 * {@code OriginStringSubstitutor} supports this recursive substitution in variable names, but it has to be enabled explicitly
 ...
 * @since 1.3
 */
public final class OriginStringSubstitutor {
     ...
     */
    private static final StringMatcher DEFAULT_PREFIX = StringMatcherFactory.INSTANCE.stringMatcher(DEFAULT_VAR_START);

    /**
     * Constant for the default variable suffix.
     */
    private static final StringMatcher DEFAULT_SUFFIX = StringMatcherFactory.INSTANCE.stringMatcher(DEFAULT_VAR_END);

    /**
     * Constant for the default value delimiter of a variable.
     */
    private static final StringMatcher DEFAULT_VALUE_DELIMITER = StringMatcherFactory.INSTANCE
...
//     * <p>
//     * This OriginStringSubstitutor lets you perform substituions like:
//     * </p>
//     *
//     * <pre>
//     * OriginStringSubstitutor.createInterpolator().replace(
...
//     * @since 1.8
//     */
//    public static OriginStringSubstitutor createInterpolator() {
//        return new OriginStringSubstitutor(StringLookupFactory.INSTANCE.interpolatorStringLookup());
//    }
    ...
    public static <V> String replace(final Object source, final Map<String, V> valueMap) {
        return new OriginStringSubstitutor(valueMap).replace(source);
    }
...
//        final String suffix) {
//        return new OriginStringSubstitutor(valueMap, prefix, suffix).replace(source);
//    }
...
//        }
//        return OriginStringSubstitutor.replace(source, valueMap);
//    }
    ...
    public static String replaceSystemProperties(final Object source) {
        return new OriginStringSubstitutor(StringLookupFactory.INSTANCE.systemPropertyStringLookup()).replace(source);
    }
...
//     */
//    public OriginStringSubstitutor() {
...
//    }
     ...
     */
    public <V> OriginStringSubstitutor(final Map<String, V> valueMap) {
...
//     * @throws IllegalArgumentException if the prefix or suffix is null
//     */
//    public <V> OriginStringSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix) {
...
//    }
     ...
     */
    private OriginStringSubstitutor(final StringLookup variableResolver) {
...
//     * @throws IllegalArgumentException if the prefix or suffix is null
//     */
//    public OriginStringSubstitutor(final StringLookup variableResolver, final String prefix, final String suffix,
//        final char escape) {
...
//    }
     ...
     * @throws IllegalArgumentException if the prefix or suffix is null
     */
    private OriginStringSubstitutor(final StringLookup variableResolver, final StringMatcher prefixMatcher,
...
//    /**
//     * Creates a new instance based on the given OriginStringSubstitutor.
//     *
//     * @param other The OriginStringSubstitutor is use as the source.
//     * @since 1.9
//     */
//    public OriginStringSubstitutor(final OriginStringSubstitutor other) {
...
//    }
     ...
     * @throws IllegalArgumentException if variable is not found when its allowed to throw exception
     */
    private boolean replaceIn(final StringBuilder source, final int offset, final int length) {
        if (source == null) {
            return false;
        }
        final TextStringBuilder buf = new TextStringBuilder(length).append(source, offset, length);
...
//     * @throws IllegalArgumentException if variable is not found when its allowed to throw exception
//     */
//    private boolean replaceIn(final TextStringBuilder source) {
//        if (source == null) {
//            return false;
//        }
...
//     */
//    public OriginStringSubstitutor setDisableSubstitutionInValues(final boolean disableSubstitutionInValues) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setEnableSubstitutionInVariables(final boolean enableSubstitutionInVariables) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setEnableUndefinedVariableException(final boolean failOnUndefinedVariable) {
...
//    }
     ...
     * @return this, to enable chaining
     */
    private OriginStringSubstitutor setEscapeChar(final char escapeCharacter) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setPreserveEscapes(final boolean preserveEscapes) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setValueDelimiter(final char valueDelimiter) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setValueDelimiter(final String valueDelimiter) {
...
//    }
     ...
     * @return this, to enable chaining
     */
    private OriginStringSubstitutor setValueDelimiterMatcher(final StringMatcher valueDelimiterMatcher) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setVariablePrefix(final char prefix) {
...
//     */
//    public OriginStringSubstitutor setVariablePrefix(final String prefix) {
...
//    }
     ...
     */
    private OriginStringSubstitutor setVariablePrefixMatcher(final StringMatcher prefixMatcher) {
     ...
     * @return this, to enable chaining
     */
    private OriginStringSubstitutor setVariableResolver(final StringLookup variableResolver) {
...
//     * @return this, to enable chaining
//     */
//    public OriginStringSubstitutor setVariableSuffix(final char suffix) {
...
//     */
//    public OriginStringSubstitutor setVariableSuffix(final String suffix) {
...
//    }
     ...
     */
    private OriginStringSubstitutor setVariableSuffixMatcher(final StringMatcher suffixMatcher) {
